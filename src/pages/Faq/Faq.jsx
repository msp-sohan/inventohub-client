            ...
            <div className="max-w-5xl p-4 mx-auto">
               <div className="text-center mb-14">
                  ...
                  <p className="max-w-xl mx-auto text-gray-500">
                     Welcome to our Frequently Asked Questions section. Here, we address common queries about our inventory hub and services.
                  </p>
               </div>
                  ...
                  <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
                     ...
                     <div className="flex">
                        ...
                        <div className="flex-1">
                           ...
                           <div className="mt-3 text-sm text-gray-500 dark:text-gray-400 answer">
                              Our shipping process involves careful handling and prompt delivery of your orders to your specified address. We strive to ensure timely and secure delivery.
                           </div>
                        </div>
                     </div>
                     <div className="flex">
                        ...
                        <div className="flex-1">
                           <span className="font-bold dark:text-white">
                              What tools do you provide for managing inventory?
                           </span>
                           <div className="mt-3 text-sm text-gray-500 dark:text-gray-400 answer">
                              We offer a range of tools for inventory management, including real-time tracking, automated alerts, and customizable reporting features.
                     ...
                     <div className="flex">
                        ...
                        <div className="flex-1">
                           ...
                           <div className="mt-3 text-sm text-gray-500 dark:text-gray-400 answer">
                              We support various payment methods, including credit/debit cards, bank transfers, and online payment gateways, to ensure convenient transactions for our customers.
                           </div>
                        </div>
                     </div>
                  </div>
