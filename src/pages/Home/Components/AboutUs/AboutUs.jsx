            ...
            <div data-aos="fade-up" className="flex flex-wrap">
               ...
               <div className="w-full px-4 mb-10 lg:w-1/2 lg:mb-0">
                  ...
                  <p className="mt-6 mb-10 text-base leading-7 text-gray-500 dark:text-gray-400">
                     We are dedicated to providing exceptional services and creating a positive impact. Our mission is to empower individuals and businesses by offering innovative solutions that cater to your unique needs.At our core, we believe in the power of technology and collaboration.Join us on this journey towards excellence. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.
                  </p>
                  <a
                     href="#"
