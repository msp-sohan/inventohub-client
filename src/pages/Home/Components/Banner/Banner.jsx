   ...
   return (
      <>
         ...
         >
            ...
            <SwiperSlide>
               <div className="relative overflow-hidden bg-white dark:bg-gray-800">
                  <div className="mx-auto max-w-7xl">
                     <div className="relative z-10 pb-8 sm:pb-16 md:pb-20 lg:max-w-2xl lg:full lg:pb-28 xl:pb-24">
                        <div className="px-4 mx-auto mt-10 max-w-7xl sm:mt-12 sm:px-6 md:mt-16 lg:mt-16 lg:px-8 xl:mt-24">
                           <div className="max-w-lg mx-auto mb-8 text-left md:text-center lg:max-w-md lg:mx-0 lg:text-left">
                              <span
                                 className="inline-block px-2.5 py-0.5 font-semibold text-xs leading-5 text-blue-600 bg-blue-100 rounded-md">Inventory</span>
                              <h2
                                 className="mt-6 text-2xl font-bold leading-10 tracking-tight text-gray-800 dark:text-gray-300 md:text-4xl">
                              ...
                              <div className="justify-start md:justify-center mt-6 lg:justify-start gap-3 flex">
                                 <div className="">
                                    <a href=""
                                 ...
                                 <div className="">
                                    <a href=""
                                       className="flex items-center justify-center w-full px-8 py-3 text-blue-900 bg-gray-300 rounded-md shadow hover:text-gray-100 hover:bg-blue-500 ">
                                       Learn More</a>
                                 </div>
                              </div>
                           </div>
            ...
            <SwiperSlide>
               {/* <div className="py-10 mx-auto sm:mt-12 sm:px-6 md:pt-16 lg:py-20 lg:px-8 xl:py-28 flex gap-3 lg:flex-justify lg:flex flex-col lg:flex-row"> */}
               <div className="bg-white dark:bg-gray-800 ">
                  <div className='flex flex-col lg:flex-row lg:justify-center items-center  py-[69px] max-w-7xl mx-auto'>
                     <div className="sm:text-center flex-1 lg:text-left">
                        <h1 className="text-2xl lg:text-4xl w-[95%] md:w-full mx-auto tracking-tight font-extrabold text-gray-800 sm:text-4xl md:text-4xl">
                           <span className="block xl:inline dark:text-white">Efficient Data Management for Your</span>
                           <span className="block text-indigo-600 xl:inline"> Inventory Operations</span>
                        </h1>
                        <p
                           className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0 w-[95%] md:w-full mx-auto">
                        ...
                        <div className="mt-5 sm:mt-8 flex gap-5 sm:justify-center lg:justify-start">
                           <div className="rounded-md shadow">
                              <a href="#"
                                 className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-blue-600 hover:bg-gray-600 md:py-4 md:text-lg md:px-10">
                                 Get started
                              </a>
                           </div>
                     ...
                     <div className="lg:inset-y-0 lg:right-0 lg:w-1/2 my-4 flex-1 hidden md:block">
