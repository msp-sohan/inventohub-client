                     ...
                     <div className="flex flex-wrap items-center px-4">
                        <div className="w-full px-4 mb-16 md:w-1/2 md:mb-0">
                           ...
                           <p className="mb-6 font-medium tracking-wide text-gray-600 dark:text-gray-400 md:text-lg">
                              Unlock the doors to success with our comprehensive business solutions. Achieve your goals and overcome challenges with enthusiasm and determination.
                           </p>
                           <a href="#"
                     ...
                     <div className="relative z-10 pb-8 sm:pb-16 md:pb-20 lg:max-w-2xl lg:full lg:pb-28 xl:pb-32">
                        <div className="px-4 mx-auto mt-10 max-w-7xl sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                           <div className="max-w-lg mx-auto mb-8 text-center lg:max-w-md lg:mx-0 lg:text-left">
                              <span
                                 className="inline-block px-2.5 py-0.5 font-semibold text-xs leading-5 text-blue-600 bg-blue-100 rounded-md">Company</span>
                              <h2
                                 className="mt-6 text-4xl font-bold leading-10 tracking-tight text-gray-800 dark:text-gray-300 md:text-6xl">
                              ...
                              <p
                                 ...
                                 Elevate your business with the product that defines success. Accomplish your aims with determination and enthusiasm.
                              </p>
                  ...
                  <div className="my-10 mx-auto max-w-7xl sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28 flex gap-3 lg:flex-justify lg:flex flex-col lg:flex-row">
                     <div className="sm:text-center lg:text-left">
                        ...
                        <p
                           ...
                           Leverage data to enhance your online business. Our platform provides the tools you need for success.
                        </p>
