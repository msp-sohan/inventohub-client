                     ...
                     <div data-aos="fade-up" className="mb-8 text-center bg-white rounded shadow-[rgba(17,_17,_26,_0.1)_0px_0px_16px] dark:bg-gray-700">
                        <div className="relative z-20 -mt-14 ">
                           ...
                           <div className="flex flex-col items-center pb-5 bg-blue-500 gap-x-4">
                              <svg className="wave-top" viewBox="0 0 1439 147" version="1.1"
                                 ...
                                 <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                                    <g transform="translate(-1.000000, -14.000000)" fillRule="nonzero">
                                       <g className="wave fill-white dark:fill-gray-700" fill="#fff">
                                          <path
                              ...
                              <div
                                 className="relative w-24 h-24 -mt-16 overflow-hidden border-4 border-white rounded-full">
                        ...
                        <div className="relative z-20 -mt-14 ">
                           ...
                           <div className="flex flex-col items-center pb-5 bg-blue-500 gap-x-4">
                              <svg className="wave-top" viewBox="0 0 1439 147" version="1.1"
                                 ...
                                 <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                                    <g transform="translate(-1.000000, -14.000000)" fillRule="nonzero">
                                       <g className="wave fill-white dark:fill-gray-700" fill="#f8fafc">
                                          <path
                                             d="M1440,84 C1383.555,64.3 1342.555,51.3 1317,45 C1259.5,30.824 1206.707,25.526 1169,22 C1129.711,18.326 1044.426,18.475 980,22 C954.25,23.409 922.25,26.742 884,32 C845.122,37.787 818.455,42.121 804,45 C776.833,50.41 728.136,61.77 713,65 C660.023,76.309 621.544,87.729 584,94 C517.525,105.104 484.525,106.438 429,108 C379.49,106.484 342.823,104.484 319,102 C278.571,97.783 231.737,88.736 205,84 C154.629,75.076 86.296,57.743 0,32 L0,0 L1440,0 L1440,84 Z">
                                          </path>
                                       </g>
